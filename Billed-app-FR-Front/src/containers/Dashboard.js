...
export default class {
  ...
  handleShowTickets(e, bills, index) {
    ...
    // si la liste est ouverte, le statut change à true et le code s'exécute
    ...
    bills.forEach(bill => {
      // On enlève l'évènement attaché et on le rattache avec "off", "on"
      $(`#open-bill${bill.id}`).off().on().click((e) => this.handleEditTicket(e, bill, bills));
    });

    // si aucune liste est ouverte, alors l'icone réapparaît
